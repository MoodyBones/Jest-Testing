...
describe('Learner Activity Challenge', () => {
  ...
  it('returns the number of days as first element of the array', () => {
    ...
    const numberCompletedLessons = app.getNumberOfCompletedLessons(
      threeCompletedLessons
    )
  ...
  it('returns Slow Starter', () => {
    ...
    const anotherRes = app.getStatus(anotherSlowStarterArray)
    expect(anotherRes).toEqual('Slow starter')
  })
